...
![Insert Throughput Comparison](/plots/insert_throughput.svg)
...
![Point Query Throughput - Warm](/plots/point_query_throughput_warm.svg)

![Point Query Throughput - Cold](/plots/point_query_throughput_cold.svg)

![Point Query Speedup - Warm](/plots/point_query_speedup_warm.svg)

![Point Query Speedup - Cold](/plots/point_query_speedup_cold.svg)
...
![Range Query Throughput - Warm](/plots/range_query_throughput_warm.svg)

![Range Query Throughput - Cold](/plots/range_query_throughput_cold.svg)

![Range Query Speedup - Warm](/plots/range_query_speedup_warm.svg)
